            ...
            <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-2xl overflow-hidden transform transition-all hover:scale-[1.01]">
                ...
                <div class="p-8 pt-0">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('password.request') }}" class="text-sm font-medium text-black dark:text-white hover:text-gray-900 dark:hover:text-gray-100">
                                Forgot password?
                            </a>
                        </div>
                ...
                <div class="px-8 py-6 bg-gray-50 dark:bg-gray-900/50 border-t dark:border-gray-700">
                    <p class="text-sm text-center text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('register') }}" class="font-medium text-black dark:text-white hover:text-gray-900 dark:hover:text-gray-100">
                            Create account
                        </a>
                    </p>
                </div>
