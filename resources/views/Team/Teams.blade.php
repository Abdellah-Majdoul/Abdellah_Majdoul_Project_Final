            ...
            <div class="container mx-auto px-4 py-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($teams as $team)
                        <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                            <div class="p-6">
                                ...
                                <form method="POST" action="{{ route('teams.destroy', $team->id) }}" class="inline">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="text-red-500 hover:text-red-700 transition duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                        ...
                        <!-- Invite Modal -->
                        <div id="inviteModal-{{ $team->id }}"
                            class="modal hidden fixed inset-0 bg-gray-900 bg-opacity-60 flex items-center justify-center px-4">
                            <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 space-y-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <button onclick="closeModal('inviteModal-{{ $team->id }}')"
                                ...
                                <form action="{{ route('invitation.store', $team->id) }}" method="post"
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email-{{ $team->id }}" name="email"
                        ...
                        <!-- task modal-->
                        <div id="taskModal-{{ $team->id }}"
                            class="fixed inset-0 z-50 flex items-center justify-center hidden bg-gray-800 bg-opacity-70">
                            <div
                                class="modal-content w-full max-w-md bg-white rounded-xl shadow-lg transform transition-all">
                                <div class="flex justify-between items-center p-4 border-b border-gray-200">
                                    <h2 class="text-xl font-semibold text-gray-800">Create New Task</h2>
                                    <button onclick="closeModal('taskModal-{{ $team->id }}')"
                                ...
                                <form method="POST" action="{{ route('task.store') }}" class="px-6 py-4">
                                    ...
                                    <div class="mb-4 flex space-x-4">
                                        ...
                                        <div class="w-1/2">
                                            <label for="end" class="block text-sm font-medium text-gray-700">End
                                                Date</label>
